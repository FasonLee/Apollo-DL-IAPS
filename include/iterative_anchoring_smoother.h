...
#include "util/quintic_polynomial_curve1d.h"
#include "include/discretized_path.h"
...
class IterativeAnchoringSmoother {
 public:
  ...
  std::vector<std::vector<common::math::Vec2d>> collided_ego_box_;
 ...
 private:
  ...
  DiscretizedPath smoothed_path_points_;
};
}  // namespace planning
}  // namespace apollo
